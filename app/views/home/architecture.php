...
<div class="doc-wrapper">
    <div class="container-fluid">
        <div id="doc-header" class="doc-header text-center">
            <h1 class="doc-title"><i class="icon icon_puzzle_alt"></i> Architecture </h1>
                ...
                <div class="content-inner">
                    <section id="projet" class="doc-section">
                        ...
                        <div id="TokenJWT" class="section-block ml75">
                            ...
                            <p>
                                Cette classe static est utilisée pour la génération de token <a target="_blank" href="https://jwt.io/">JWT (JSON WEB TOKEN)</a>.
                            </p>
                        </div><!--//section-block ml75-->
                        ...
                        <nav class="doc-sub-menu nav flex-column">
                            ...
                            <nav class="doc-sub-menu nav flex-column ml25">
                                ...
                                <nav class="doc-sub-menu nav flex-column ml25">
                                    ...
                                    <a class="nav-link scrollto" href="#us"><i class="fa fa-file-code-o mr10"></i>us</a>
                                </nav><!--//nav-->
