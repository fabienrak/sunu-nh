<div class="container-fluid">
    ...
    <!-- /row -->
    <div class="row">
        <form action="<?= WEBROOT; ?>_name_crud_/addAffectation" method="post">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0"><?= $this->lang['affectation_droit_profil']; ?> : <?= $nomProfil ; ?></h3>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <input class="form-check-input" type="checkbox" style="position: absolute;right: 60px;" id="ica-<?= strtolower(str_replace(" ", "-", $lib_sm)); ?>"
                                                                        ...
                                                                        <?php foreach ($one_sm as $val) { ?>
                                                                            <div class="col-md-6">
                                                                                <div class="form-check form-check-inline">
                                                                                    <input <?= (isset($val['id_aff']) && $val['etat_aff'] == 1 ? 'checked' : '') ?>
